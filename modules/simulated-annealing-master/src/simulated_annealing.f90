...
!  * get ideas from: https://docs.scipy.org/doc/scipy/reference/generated/scipy.optimize.basinhopping.html
    ...
    type,public :: simulated_annealing_type
        ...
        integer :: n_resets = 3 !! number of times to run the main loop (must be >=1)
    ...
    !*******************************************************
    abstract interface
        subroutine sa_func(me, x, f, istat,fdata_)
...
!     3. references to paper updated.
    ...
    subroutine sa(me, x, rt, t, vm, xopt, fopt, nacc, nfcnev, ier,fdata_)
    ...
    real(dp),optional,dimension(:)          :: fdata_     !! data passed to solver
...
!  elements in vector, 10 elements will be printed on each line.
    ...
    subroutine print_matrix(n,m,A,txt)

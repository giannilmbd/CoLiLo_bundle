...
!***********************************************************************************
	...
	call plot(x1,f1,terminal='qt',persist='yes',pause=-1.0)
...
! ***********************************************************************************
	...
	call plot(x1,f1,'10-',terminal='qt')
	print *,'press ENTER to go to the next example'
	read  *
! ***********************************************************************************
	print *,'********************************************************************'
...
! ***********************************************************************************
	...
	call plot(x1,f1,'15-',pause=5.0,persist='no',terminal='qt')
	print *,'press ENTER to go to the next example'
	read  *
! ***********************************************************************************
	print *,'********************************************************************'
	...
	call plot(x1,f1,'15-',pause=-1.0,terminal='qt')
! ***********************************************************************************
	print *,'********************************************************************'
	print *,'Example 6: specifying color'
	print *,'call plot(x1,f1,''21-'',pause=-1.0,persist=''no'',color1=''red'')'
	call plot(x1,f1,'21-',pause=-1.0,persist='no',color1='red',terminal='qt')
! ***********************************************************************************
	print *,'********************************************************************'
...
! ***********************************************************************************
	...
	call plot(x1,f1,' 0-',pause=-2.0,persist='no',linewidth=3.5,terminal='qt')
! ***********************************************************************************
	print *,'********************************************************************'
...
! ***********************************************************************************
	...
	call plot(x1,f1,x2,f2,x3,f3,x4,f4,' 5.22- 0- 0-',color2='dark-yellow',color1='#40e0d0',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
	print *,'********************************************************************'
	...
	call plot(x1,f1,x2,f2,x3,f3,x4,f4,pause=-1.0,persist='no',polar='yes',linewidth=2.0,terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 16: histogram with 10 bins'
	print *,'call hist(f1,10,color=''#779944'',pause=-1.0,persist=''no'')'
	call  hist(f1,10,color='#779944',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 17: 3D plot of a curve'
	print *,'call plot3D(u1,u2,u3,pause=-1.0,persist=''no'',linewidth=2.0)'
	call  plot3D(u1,u2,u3,pause=-1.0,persist='no',linewidth=2.0,terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 18: surface plot'
	print *,'call surf(xx,yy,zz)'
	call  surf(xx,yy,zz,terminal='qt')
	print *,'press ENTER to go to the next example'
	read  *
! ***********************************************************************************
 	print *,'********************************************************************'
...
! ***********************************************************************************
	...
	call  surf(xyz,pm3d='pm3d',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 22: parametric surface plot, different palette'
	print *,'call surf(xyz,pm3d=''pm3d'',palette=''RGB'',pause=-1.0,persist=''no'')'
	call  surf(xyz,pm3d='pm3d',palette='RGB',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	...
	call  surf(xyz,pm3d='pm3d',palette='gray negative',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'*******************************************************************'
	...
	call  surf(xyz,pm3d='pm3d',palette='rgbformulae 23,28,3',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 25: surface plot'
	print *,'call surf(xx,yy,zz,pm3d=''pm3d at b'',palette=''HSV'',pause=-1.0,persist=''no'')'
	call  surf(xx,yy,zz,pm3d='pm3d at b',palette='HSV',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	...
	call  surf(xx,yy,zz,pm3d='pm3d implicit map',palette='rgbformulae 31,-11,32',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	...
	call  surf(xx,yy,zz,contour='surface',palette='YIQ',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 28: surface plot with contour on the XY plane'
	print *,'call surf(xx,yy,zz,contour=''xy'',pause=-1.0,persist=''no'')'
	call  surf(xx,yy,zz,contour='xy',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	...
	call  surf(xx,yy,zz,contour='both',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'
	print *,'Example 30: image plot'
	print *,'call image(z_fractal,palette=''gray'',pause=-1.0,persist=''no'')'
	call  image(z_fractal,palette='gray',pause=-1.0,persist='no',terminal='qt')
! ***********************************************************************************
 	print *,'********************************************************************'

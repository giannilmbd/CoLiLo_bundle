...
! pC_sols=1.0e0_wp
 ...
 ! fist check if policy functions exist either for each country or for default country            
      ...
      call read_csv(filename=trim(StrStrStr(dir=trim(dir), str1='v3_data_'//mom2loop//'_', cnt=cntry, str2='.csv')), data=matrix_csv_v3)
      ...
      call read_csv(filename=trim(StrStrStr(dir=trim(dir),str1='v3_aut_data_'//mom2loop//'_', cnt=cntry, str2='.csv')), data=matrix_csv_aut_v3)
      ...
      write(*,*) ANSI_RED//'NOT FOUND FILES FOR POLICY COUNTRY ==>'//cntry//': LOADING DEFAULT COUNTRY ==>>'//def_cntry//ANSI_RESET
        ...
        call read_csv(filename=trim(StrStrStr(dir=trim(dir), str1='v3_data_'//mom2loop//'_', cnt=def_cntry, str2='.csv')), data=matrix_csv_v3)
        ...
        call read_csv(filename=trim(StrStrStr(dir=trim(dir),str1='v3_aut_data_'//mom2loop//'_', cnt=def_cntry, str2='.csv')), data=matrix_csv_aut_v3)
...
subroutine save_results_CRRA_3c(dir,cnt_mom)
   ...
   call write_csv(filename=trim(StrStrStr(dir=trim(dir), str1='v2_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_csv_v2)
   call write_csv(filename=trim(StrStrStr(dir=trim(dir), str1='v3_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_csv_v3)
   ...
   call write_csv(filename=trim(StrStrStr(dir=trim(dir), str1='pC_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_csv_pC)
        ...
        call write_csv(filename=trim(StrStrStr(dir=trim(dir),str1='v2_aut_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_csv_aut_v2)
        call write_csv(filename=trim(StrStrStr(dir=trim(dir),str1='v3_aut_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_csv_aut_v3)
        ...
        call write_csv(filename=trim(StrStrStr(dir=trim(dir),str1='coef_v2_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_coefs_csv_v2)
        call write_csv(filename=trim(StrStrStr(dir=trim(dir),str1='coef_v3_data_'//mom2loop//'_', cnt=cnt_mom, str2='.csv')), data=matrix_coefs_csv_v3)

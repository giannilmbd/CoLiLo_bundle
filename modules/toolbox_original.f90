...
!##############################################################################
    ...
    !##############################################################################
    subroutine newton_interpol(x, funcv, check_return,parin_newton)
        ...
        real*8, intent(inout) :: x
        real*8,optional,intent(in) :: parin_newton(:)
        ...
        ! interface for the function
        interface
            function funcv(p,parin_newton)
                implicit none
                real*8, intent(in) :: p
                real*8,intent(in)::parin_newton(:)
        ...
        f1 = funcv(x1,parin_newton)
        f2 = funcv(x2,parin_newton)

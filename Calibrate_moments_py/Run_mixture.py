...
# %% ------------------------------------  Load Packages ------------------------------------ #
import os
os.chdir('/home/gianni/Dropbox/projects/ANNAGIANCARLOGIANNI/CoLiLoGlobal/Calibrate_moments_py')
import numpy as np
import pandas as pd
...
def country_level(cnt_c,country_id,muC,pC,sigmaC,Nm,emp_moms_csv,n_moments): 
    ...
    p_even1, x_even1,match_order,resid = discrete_gmar(mu, A1, pC, muC,
                                                        sigmaC, Nm, n_moments,
                                                        method='even',
...
i=int(np.where(country_id=="FRA")[0])

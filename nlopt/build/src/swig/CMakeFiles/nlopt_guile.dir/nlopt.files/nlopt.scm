...
(set! NLOPT-NUM-FAILURES (NLOPT-NUM-FAILURES))
...
(set! NLOPT-NUM-RESULTS (NLOPT-NUM-RESULTS))

(export new-bad-cast
        delete-bad-cast
        new-bad-exception
        delete-bad-exception
        new-logic-error
        delete-logic-error
        new-domain-error
        delete-domain-error
        ...
        delete-range-error
        new-overflow-error
        delete-overflow-error
        new-underflow-error
        delete-underflow-error
        ...
        nlopt-opt-get-exceptions-enabled
        nlopt-opt-set-exceptions-enabled
        nlopt-srand
        nlopt-srand-time
        nlopt-version
        nlopt-version-major

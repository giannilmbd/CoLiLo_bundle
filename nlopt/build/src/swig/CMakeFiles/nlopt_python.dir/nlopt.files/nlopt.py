...
class exception(Exception):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _nlopt.delete_exception

    def what(self):
        return _nlopt.exception_what(self)

    def __init__(self):
        _nlopt.exception_swiginit(self, _nlopt.new_exception())

# Register exception in _nlopt:
_nlopt.exception_swigregister(exception)
class bad_cast(exception):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _nlopt.bad_cast_swiginit(self, _nlopt.new_bad_cast())
    __swig_destroy__ = _nlopt.delete_bad_cast

# Register bad_cast in _nlopt:
_nlopt.bad_cast_swigregister(bad_cast)
class bad_exception(exception):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self):
        _nlopt.bad_exception_swiginit(self, _nlopt.new_bad_exception())
    __swig_destroy__ = _nlopt.delete_bad_exception

# Register bad_exception in _nlopt:
_nlopt.bad_exception_swigregister(bad_exception)
class logic_error(exception):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.logic_error_swiginit(self, _nlopt.new_logic_error(msg))
    __swig_destroy__ = _nlopt.delete_logic_error

# Register logic_error in _nlopt:
_nlopt.logic_error_swigregister(logic_error)
class domain_error(logic_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.domain_error_swiginit(self, _nlopt.new_domain_error(msg))
    __swig_destroy__ = _nlopt.delete_domain_error

# Register domain_error in _nlopt:
_nlopt.domain_error_swigregister(domain_error)
class invalid_argument(logic_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.invalid_argument_swiginit(self, _nlopt.new_invalid_argument(msg))
    __swig_destroy__ = _nlopt.delete_invalid_argument

# Register invalid_argument in _nlopt:
_nlopt.invalid_argument_swigregister(invalid_argument)
class length_error(logic_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.length_error_swiginit(self, _nlopt.new_length_error(msg))
    __swig_destroy__ = _nlopt.delete_length_error

# Register length_error in _nlopt:
_nlopt.length_error_swigregister(length_error)
class out_of_range(logic_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.out_of_range_swiginit(self, _nlopt.new_out_of_range(msg))
    __swig_destroy__ = _nlopt.delete_out_of_range

# Register out_of_range in _nlopt:
_nlopt.out_of_range_swigregister(out_of_range)
class runtime_error(exception):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.runtime_error_swiginit(self, _nlopt.new_runtime_error(msg))
    __swig_destroy__ = _nlopt.delete_runtime_error

# Register runtime_error in _nlopt:
_nlopt.runtime_error_swigregister(runtime_error)
class range_error(runtime_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.range_error_swiginit(self, _nlopt.new_range_error(msg))
    __swig_destroy__ = _nlopt.delete_range_error

# Register range_error in _nlopt:
_nlopt.range_error_swigregister(range_error)
class overflow_error(runtime_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.overflow_error_swiginit(self, _nlopt.new_overflow_error(msg))
    __swig_destroy__ = _nlopt.delete_overflow_error

# Register overflow_error in _nlopt:
_nlopt.overflow_error_swigregister(overflow_error)
class underflow_error(runtime_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, msg):
        _nlopt.underflow_error_swiginit(self, _nlopt.new_underflow_error(msg))
    __swig_destroy__ = _nlopt.delete_underflow_error

# Register underflow_error in _nlopt:
_nlopt.underflow_error_swigregister(underflow_error)
...
class roundoff_limited(runtime_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class forced_stop(runtime_error):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class opt(object):
    ...
    def get_exceptions_enabled(self):
        return _nlopt.opt_get_exceptions_enabled(self)

    def set_exceptions_enabled(self, enable):
        return _nlopt.opt_set_exceptions_enabled(self, enable)

...
real(wp),  private  :: tbox_gftol = 1d-6
...
! Level of tolerance for all routines
real(wp),  private  :: tbox_gftol_root = 1d-6
...
!##############################################################################
    ...
    function normalPDF(x, mu, sigma)
        ...
        real(wp), parameter :: pi = 3.1415926535897d0
    ...
    function normalCDF(x, mu, sigma)
        ...
        real(wp), parameter :: a0  = 0.5d0
        real(wp), parameter :: a1  = 0.398942280444d0
        real(wp), parameter :: a2  = 0.399903438504d0
        real(wp), parameter :: a3  = 5.75885480458d0
        real(wp), parameter :: a4  = 29.8213557808d0
        real(wp), parameter :: a5  = 2.62433121679d0
        real(wp), parameter :: a6  = 48.6959930692d0
        real(wp), parameter :: a7  = 5.92885724438d0
        real(wp), parameter :: b0  = 0.398942280385d0
        real(wp), parameter :: b1  = 3.8052d-8
        real(wp), parameter :: b2  = 1.00000615302d0
        real(wp), parameter :: b3  = 3.98064794d-4
        real(wp), parameter :: b4  = 1.98615381364d0
        real(wp), parameter :: b5  = 0.151679116635d0
        real(wp), parameter :: b6  = 5.29330324926d0
        real(wp), parameter :: b7  = 4.8385912808d0
        real(wp), parameter :: b8  = 15.1508972451d0
        real(wp), parameter :: b9  = 0.742380924027d0
        real(wp), parameter :: b10 = 30.789933034d0
        real(wp), parameter :: b11 = 3.99019417011d0
    ...
    function normalCDF_Inv(x, mu, sigma)
        ...
        real(wp), parameter :: a(8) = (/  3.3871328727963666080d0, &
        ...
        real(wp), parameter :: c(8) = (/  1.42343711074968357734d0, &
        ...
        real(wp), parameter :: const1 = 0.180625d0
        real(wp), parameter :: const2 = 1.6d0
        real(wp), parameter :: d(8) = (/  1.0d0, &
        ...
        real(wp), parameter :: e(8) = (/  6.65790464350110377720d0, &
    ...
    function incomplete_gamma(x, p)
        ...
        real(wp), parameter :: elimit = - 88d0
        real(wp), parameter :: oflo = 1d37
        real(wp), parameter :: plimit = 1000d0
        real(wp), parameter :: tol = 1d-14
        real(wp), parameter :: xbig = 1d8
    ...
    function my_log_gamma(x_in)
        ...
        real(wp), parameter :: alr2pi = 9.18938533204673d-1
        real(wp), parameter :: xlge = 5.10d6 
        real(wp), parameter :: r1(9) = (/ -2.66685511495d0, &
                                        -2.44387534237d1, &
                                        -2.19698958928d1, & 
                                         1.11667541262d1, &
                                         3.13060547623d0, &
                                         ...
                                         3.14690115749d1, &
                                         1.52346874070d1 /)
        real(wp), parameter :: r2(9) = (/ -7.83359299449d1, &
                                        -1.42046296688d2, &
                                         1.37519416416d2, & 
                                         7.86994924154d1, &
                                         4.16438922228d0, &
                                         ...
                                         2.63505074721d2, &
                                         4.33400022514d1 /)
        real(wp), parameter :: r3(9) = (/ -2.12159572323d5, & 
                                         2.30661510616d5, &
                                         2.74647644705d4, &
                                        -4.02621119975d4, &
                                        -2.29660729780d3, &
                                        ...
                                        -2.42357409629d4, &
                                        -5.70691009324d2 /)
        real(wp), parameter :: r4(5) = (/  2.79195317918525d-1, &
    ...
    subroutine simulate_normal_1(x, mu, sigma, fixed)
        ...
        real(wp) :: pi = 3.141592653589793d0
    ...
    subroutine normal_discrete_1(x, prob, mu, sigma)
        ...
        real(wp) :: mu_c, sigma_c, pim4, z=0d0, z1, p1, p2, p3, pp
        integer :: n, m, i, j, its
...
!##############################################################################
    ...
    subroutine brent(xmin, fret, minimum, maximum, func)
        ...
        real(wp) :: tol
        real(wp), parameter :: cgold = 0.3819660d0
        real(wp), parameter :: zeps = 1.0e-3*epsilon(xmin)
        real(wp) :: a=0d0, b=0d0, d=0d0, e=0d0, etemp, fu, fv, fw, fx, p, q, r, tol1, tol2, &
            u, v, w, x, xm, ax, bx, cx
        integer :: iter
    ...
    contains
        ...
        function brent_pow(ax, bx, cx, tol, xmin, func)
            ...
            integer :: iter
            real(wp) :: a=0d0, b=0d0, d=0d0, e=0d0, etemp=0d0
...
!##############################################################################
    ...
    contains
        ...
        subroutine lnsrch(xold, fold, g, p, x, f, stpmax, check, funcv,parin)
            ...
            integer :: ndum
            real(wp) :: a, alam, alam2=0d0, alamin, b, disc, f2=0d0, pabs, rhs1, rhs2, &
                slope, tmplam

...
real*8,  private  :: tbox_gftol = 1d-6
...
! Level of tolerance for all routines
real*8,  private  :: tbox_gftol_root = 1d-6
...
!##############################################################################
    ...
    subroutine newton_interpol(x, funcv, check_return,parin_)
        ...
        real*8, intent(inout) :: x
        real*8, intent(in),optional :: parin_(:)
    ...
    subroutine broydn(x, funcv, check_return,parin)
        ...
        real*8, parameter :: stpmx = 100d0
        integer :: i, j, k, its, n
        real*8, intent(in), optional :: parin(:)
...
!##############################################################################
    ...
    function spline3(x, c)
        ...
        real*8 :: s2, s3
        !!real*8 :: phi2_vec(NK2 + 3), phi3_vec(NK3 + 3) 
        real*8 :: phi2_vec(10), phi3_vec(10) ! NK2 + 3 = 9, NK3 + 3 = 9
...
!############################################################################## 
    ...
    subroutine spline3_2d(x, c, spline_array)
        ...
        ! value of spline function
        real*8, intent(out) :: spline_array(:,:)
        ...
        real*8 :: phi1, xtemp1, phi2, xtemp2, phi3, xtemp3
        real*8 :: s2, s3
        !! real*8 :: phi1_vec(NK1 + 3), phi2_vec(NK2 + 3), phi3_vec(NK3 + 3)
        real*8 :: phi1_vec(20), phi2_vec(10), phi3_vec(10) ! NK1 + 3 = 18, NK2 + 3 = 9, NK3 + 3 = 9
 ...
 !##############################################################################
    ...
    subroutine spline2_2d(x, c, spline_array)
        ...
        real*8 :: phi1, xtemp1, phi2, xtemp2
        real*8 :: s2
        real*8 :: phi1_vec(20), phi2_vec(10) ! NK1 + 3 = 18, NK2 + 3 = 9

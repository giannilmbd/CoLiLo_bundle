...
!##############################################################################
   ...
   real(kind=wp), parameter :: sig_pf = 1.0e-14_wp
...
!##############################################################################
   ...
   real(kind=wp), parameter :: theta = 1!5.0_wp
   ...
   character(len=3), parameter, dimension(1) :: subsample = [ "MEX"] ![ "DEU","MEX","BRA","THA"], "TUR", "ESP", "KOR", "CHN", "IND", "USA"] ! from the distro of PCU with RoW
...
! COLORS
   ...
   real(kind=wp), parameter :: step_kappa = 0.01_wp, kappa_min = 0.5_wp, kappa_max = 1.5_wp
   ...
   real(kind=wp) :: smooth_outer = 0.5_wp
   real(kind=wp),parameter :: smooth_arrow = 1.0_wp,smooth_aut = 1.0_wp

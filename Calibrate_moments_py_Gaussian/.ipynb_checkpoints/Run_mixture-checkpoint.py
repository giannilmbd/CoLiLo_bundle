...
def country_level(cnt_c,country_id,muC,pC,sigmaC,Nm,emp_moms_csv,n_moments): 
    ...
    p_even1, x_even1,match_order = discrete_gmar(mu, A1, pC, muC,
...
# display(image_png(p))
#%%    
tab_results.to_csv('calib_results.csv',index=False,header=True)
tab_results.to_latex("calib_results.tex",index=False,header=True,
                     float_format="%.5f",
